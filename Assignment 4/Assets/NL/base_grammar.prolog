...
s(kind_of(Kind2, Kind), interrogative, Polarity, Tense, simple) -->
   aux_be(Tense, _Agreement),
   kind_noun(Kind2, singular),
   [a],
   opt_not(Polarity),
   kind_noun(Kind, singular).

%s(kind_of(Kind2, Kind), interrogative, _Polarity, _Tense, simple, In, Out):-
%   aux_be(Tense,Agreement,In,L1),
%   kind_noun(Kind2, singular,L1,L2),
%   ([a],L2,L3),
%   kind_noun(Kind, singular,L3,Out),
