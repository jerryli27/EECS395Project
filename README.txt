...
We made a course selection helper in Unity that can give some course FAQ and suggestions when the user type in the game. Most of the code we added is in /Assets/Courses/csCourses.prolog. 
